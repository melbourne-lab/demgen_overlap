# Script for plotting example age distributions (supplemental figure)
# SN - 25 May 2023
...
plot.naturale = for.plot %>%
  ...
  scale_colour_gradient(low = 'darkviolet', high = 'darkorange') +
...
plot.legend = get_legend(
  plot.naturale +
    guides(colour = guide_legend(expression(phenotypic ~ variance ~ gamma^2))) +
...
ggsave(filename = 'sandbox/sandbox_figs/fig_age_distn.png',
       width = 8, height = 6)
